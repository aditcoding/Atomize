...
treeJSON = d3.json("flare.json", function(error, treeData) {
    ...
    function click(d) {
        ...
        d3.select("div.textField").text(d.text);
        document.getElementById("theImage").src = d.image;
        console.log(d.image);
    }
    ...
    function update(source) {
        ...
        childCount(0, root);
        var newHeight = d3.max(levelWidth) * 110; // number of pixels per line  
     ...
     // Update the link text
        var linktext = svgGroup.selectAll("g.linktext")
            .data(links, function (d) {
            return d.target.id;
        });                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
